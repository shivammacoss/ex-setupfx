...
const Blog = () => {
  ...
  const posts = [
    ...
    },
    {
      ...
      category: 'Platforms',
      date: 'March 5, 2025',
      excerpt: 'Learn how to follow expert traders and automatically replicate their strategies on StockPip.',
      image: '💻'
    },
    {
          ...
          <ScrollRevealGroup className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredPosts.map((post, index) => (
              <ScrollRevealItem key={index}>
                <ScrollReveal variant={index % 2 === 0 ? 'fadeLeft' : 'fadeRight'} delay={index * 0.05}>
