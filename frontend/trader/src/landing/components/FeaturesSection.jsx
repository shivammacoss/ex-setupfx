...
const GradientWord = ({ children }) => (
  <span className="bg-gradient-to-r from-[#00d048] to-[#00d048] bg-clip-text" style={{ WebkitTextFillColor: 'transparent' }}>
    {children}
  </span>
)
        ...
        >
          {cards.map((card, i) => (
            ...
            >
              ...
              >
                <card.icon
                  className="transition-colors duration-300 group-hover:text-[#00d048]"
                  style={{
                    width: 48,
                    height: 48,
                    color: '#00d048',
