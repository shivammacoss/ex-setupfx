          ...
          >
            {cards.map((card, i) => (
              ...
              >
                {/* Icon */}
                <div
                  className="w-12 h-12 rounded-xl mb-6 flex items-center justify-center transition-all duration-300 group-hover:bg-gradient-to-br group-hover:from-[#00d048] group-hover:to-[#00d048]"
                  style={{ background: 'linear-gradient(135deg, #EEF2FF, #E0E7FF)' }}
                >
                  <card.icon className="w-[22px] h-[22px] text-[#00d048] transition-colors duration-300 group-hover:text-white" />
                </div>
                ...
                {/* Bottom accent line */}
                <div className="absolute bottom-0 left-0 h-[2px] w-0 group-hover:w-full transition-all duration-300" style={{ background: 'linear-gradient(to right, #00d048, #00d048)' }} />
              </motion.div>
            ))}
          </motion.div>
