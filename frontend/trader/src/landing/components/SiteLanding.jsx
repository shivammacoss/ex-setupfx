    ...
    <div className="site-landing" ref={wrapperRef}>
      ...
      <header id="navbar" className={navScrolled ? 'scrolled' : ''}>
        <div className="nav-inner">
          ...
          <div className="nav-right">
            <span className="nav-cta-ghost" style={{ cursor: 'pointer' }} onClick={() => router.push('/auth/login')}>Login</span>
            <span className="nav-cta" style={{ cursor: 'pointer' }} onClick={() => router.push('/auth/register')}>Sign_Up</span>
          </div>
          <button
      ...
      <nav id="nav-mobile" className={mobileOpen ? 'open' : ''}>
        ...
        <div className="mobile-cta-wrap">
          <span className="nav-cta" style={{ cursor: 'pointer' }} onClick={() => { setMobileOpen(false); router.push('/auth/register'); }}>Sign_Up</span>
        </div>
      </nav>
