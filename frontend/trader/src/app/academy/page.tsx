...
const phaseMeta = [
  { icon: '◆', border: 'border-[#00d048]/30', bg: 'bg-[#00d048]/10' },
  { icon: '●', border: 'border-[#00d048]/30', bg: 'bg-[#00d048]/10' },
  { icon: '◉', border: 'border-[#00d048]/30', bg: 'bg-[#00d048]/10' },
    ...
    <DashboardShell>
      <div className="page-main max-w-6xl mx-auto w-full pb-8">
        <div className="text-center mb-8">
          <div className="inline-block px-4 py-1.5 rounded-full border border-[#00d048]/30 text-[#00d048] text-xs font-medium tracking-wider uppercase mb-4">
            ● CURRICULUM
          </div>
          <h1 className="text-3xl font-light text-text-primary tracking-wider mb-1">
            StockPip <span className="font-bold italic">FOREX</span> ACADEMY
          </h1>
          <p className="text-[#00d048] text-sm tracking-widest uppercase">MASTER FOREX TRADING FROM BEGINNER TO PROFESSIONAL</p>
          ...
          <div className="text-center mb-4">
            ...
            <p className="text-sm text-[#00d048] font-medium">
            ...
            <div className="h-2 max-w-md mx-auto mt-3 rounded-full bg-bg-secondary overflow-hidden border border-border-primary">
              <div className="h-full bg-[#00d048] rounded-full transition-all" style={{ width: `${pct}%` }} />
            </div>
          </div>
              ...
              <div key={phase.id} className="text-center">
                <div
                  className={clsx(
                    ...
                    i === 0 ? 'border-[#00d048] text-[#00d048]' : 'border-border-secondary text-text-tertiary',
                  )}
                >
                  {i + 1}
                </div>
              ...
              >
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 shrink-0">
                    ...
                    <ArrowRight size={16} className="text-text-tertiary group-hover:text-[#00d048] transition-colors" />
                  </div>
                </div>
        ...
        <div className="flex items-center justify-between mt-8 text-[10px] uppercase tracking-widest text-text-tertiary">
          <span>StockPip FOREX ACADEMY</span>
