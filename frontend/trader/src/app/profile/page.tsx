          ...
          <section className="relative overflow-hidden rounded-xl border border-border-primary bg-card">
            ...
            <div className="relative z-10 px-4 sm:px-6 py-5 sm:py-7">
              ...
              <p className="text-sm text-text-secondary mt-1 max-w-2xl">
                Profile, security, notifications, and active sessions — aligned with StockPip.
              </p>
            </div>
          </section>
              ...
              {TABS.map((t) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => setTab(t.id)}
                    className={clsx(
                      'relative z-10 flex-1 min-w-0 border-0 bg-transparent py-3 sm:py-3.5 px-1 sm:px-2 text-[11px] sm:text-xs font-semibold outline-none inline-flex flex-col xs:flex-row items-center justify-center gap-1 xs:gap-1.5 sm:gap-1.5',
                  ...
                  >
                    ...
                    <span className="xs:hidden text-[9px] font-semibold leading-none mt-0.5 truncate max-w-full">{t.label}</span>
                  </button>
                );
              })}
            </div>

            <div key={tab} className="bg-card-nested p-3 sm:p-4 md:p-6 animate-wallet-fund-enter-lg min-h-[200px]">
        {/* ── Profile tab ── */}
        {tab === 'profile' && (
          <div className="max-w-2xl mx-auto space-y-5">
            <div className="rounded-xl border border-border-primary bg-card p-4 sm:p-6 noise-texture">
              <h2 className="text-sm font-semibold text-text-primary mb-4 sm:mb-5">Profile Information</h2>
                  ...
                  <div className="w-full h-20 rounded-lg mb-3 overflow-hidden" style={{ background: '#0a0a0a', border: '1px solid #2a2a2a' }}>
                    ...
                    <div className="flex h-[calc(100%-12px)]">
                      ...
                      <div className="flex-1 p-1.5">
                        <div className="h-1.5 w-3/4 rounded-full mb-1" style={{ background: '#00d048' }} />
