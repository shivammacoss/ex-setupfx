...
export const metadata = { title: 'Risk Disclosure — StockPip' }
      ...
      <section className="py-12 bg-white">
        <div className="max-w-4xl mx-auto px-6 lg:px-8 space-y-10">
          ...
          <Section title="1. Leverage Risk">
            StockPip offers leverage up to 1:500 on certain instruments. Leverage amplifies both gains and losses. A small adverse price movement can result in substantial losses or even the complete loss of your deposit.
          ...
          <Section title="4. Counterparty Risk">
            Your trades are executed through StockPip&apos;s liquidity providers. If a liquidity provider defaults or experiences financial difficulties, your funds may be at risk despite our segregated account structure.
          </Section>
          ...
          <Section title="9. Negative Balance Protection">
            While StockPip offers negative balance protection, meaning your account cannot go below zero, this protection may not apply in all circumstances, including:
            <List items={[
          ...
          <Section title="11. Acknowledgment">
            By opening an account with StockPip, you acknowledge that you have read and understood this Risk Disclosure, and you accept all risks associated with trading on our platform. You confirm that you are trading at your own risk and that StockPip is not responsible for any losses incurred.
          </Section>
...
function ContactBox({ team, email }: { team: string; email: string }) {
  return (
    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mt-4 text-sm space-y-1">
      <p className="font-semibold text-gray-900">StockPip {team}</p>
