  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-8">
        ...
        <span className="text-white text-sm font-bold tracking-[0.25em]">EX-Setup</span>
      </div>
      ...
      {loading ? (
        ...
        <>
          ...
          <p className="text-white/40 text-xs mt-10">EX-Setup FX © {new Date().getFullYear()}. All rights reserved.</p>
        </>
      )}
    </div>
  );
