...
export const metadata = { title: 'Terms and Conditions — StockPip' }
  ...
  return (
    <div className="min-h-screen" style={{ background: 'var(--bg-primary)' }}>
      <div className="max-w-3xl mx-auto px-6 lg:px-8 py-16">
        ...
        <p className="text-lg font-semibold text-text-primary mt-8 mb-1">StockPip — Terms and Conditions</p>
        <p className="text-sm text-text-secondary mb-10">Last updated: February 2026</p>

        <div className="space-y-8">
          <Section title="1. Acceptance of Terms">
            By creating an account and using the StockPip platform, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree with any part of these terms, you must not use our services.
          </Section>
          ...
          <Section title="6. Bonus Terms">
            Promotional bonuses, including the welcome bonus, are subject to specific terms and conditions. Bonus funds may have trading volume requirements and withdrawal restrictions. StockPip reserves the right to modify or discontinue bonus programs at any time.
          </Section>
          ...
          <Section title="9. Affiliate Program">
            Participation in the affiliate program is subject to additional terms. Affiliates must promote StockPip responsibly and in compliance with all applicable advertising standards. Commissions are subject to review and may be adjusted or revoked in cases of abuse.
          </Section>
          ...
          <Section title="12. Limitation of Liability">
            StockPip shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the platform. Our total liability shall not exceed the amount of funds deposited in your account.
          </Section>

          <Section title="13. Modifications">
            StockPip reserves the right to modify these Terms and Conditions at any time. Continued use of the platform after changes are posted constitutes acceptance of the revised terms. Users will be notified of material changes via email or platform notification.
          </Section>
