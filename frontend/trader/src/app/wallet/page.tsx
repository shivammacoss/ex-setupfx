...
function WalletPageContent() {
  ...
  const [fundMainTab, setFundMainTab] = useState<'deposit' | 'withdraw'>(
    pathname?.endsWith('/withdrawal') ? 'withdraw' : 'deposit',
  );

  // Sync tab to pathname when sub-route changes (e.g., sidebar nav between Deposit/Withdrawal)
  useEffect(() => {
    if (pathname?.endsWith('/withdrawal')) setFundMainTab('withdraw');
    else if (pathname?.endsWith('/deposit') || pathname === '/wallet') setFundMainTab('deposit');
  }, [pathname]);
        ...
        <div className="w-full max-w-full space-y-4 sm:space-y-6 px-2.5 sm:px-4 py-3 sm:py-4 pb-24 md:px-6 md:py-6">
          ...
          <div className="space-y-3">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 md:gap-4">
              ...
              >
                <div className="absolute top-0 right-0 w-24 h-24 rounded-bl-[60px] bg-[#00d048]/[0.04] group-hover:bg-[#00d048]/[0.08] transition-colors duration-500" />
                <div className="relative p-3 sm:p-4 md:p-5 flex flex-col gap-2.5 sm:gap-3">
                  <div className="flex items-center justify-between">
                    <div
                      className="w-9 h-9 sm:w-11 sm:h-11 rounded-lg sm:rounded-xl flex items-center justify-center border border-[#00d048]/25"
                      style={{ background: 'linear-gradient(135deg, rgba(0,208,72,0.18) 0%, rgba(0,208,72,0.05) 100%)' }}
                    >
                      <WalletIcon className="h-4 w-4 sm:h-5 sm:w-5 text-[#00d048]" strokeWidth={2} style={{ filter: 'drop-shadow(0 0 6px rgba(0,208,72,0.5))' }} />
                    </div>
                  ...
                  <div>
                    <p className="text-[9px] sm:text-[10px] font-bold uppercase tracking-widest text-[#00d048]/60 mb-0.5 sm:mb-1">Main Wallet</p>
                  ...
                  {liveAccounts.length > 0 && (
                    <button
                      ...
                      className="flex w-full items-center justify-center gap-1.5 rounded-xl py-2.5 text-[11px] font-bold transition-all bg-[#00d048]/10 text-[#00d048] border border-[#00d048]/20 hover:bg-[#00d048]/20 hover:border-[#00d048]/40 disabled:opacity-40 disabled:pointer-events-none"
                    >
              ...
              {liveAccounts.map((a) => {
                ...
                const cardLabel = num.startsWith('IF') ? 'PAMM Investment'
                  ...
                  : num;
                const ac = isManaged ? { r: '245,158,11', hex: '#f59e0b' } : isPool ? { r: '168,85,247', hex: '#00d048' } : { r: '0,208,72', hex: '#00d048' };
          ...
          >
            {/* Curved tab shell — slides with spring; no mid-tab seam */}
                ...
                return (
                  ...
                  >
                    {active ? (
                      <span
                        key={fundMainTab}
                        className="relative inline-block animate-wallet-main-tab-text drop-shadow-[0_0_20px_rgba(0,208,72,0.7)]"
                      >
              ...
              {fundMainTab === 'deposit' ? (
                <>
                  ...
                  <div>
                    ...
                    <button
                      type="button"
                      className="w-full py-3.5 rounded-xl bg-[#00d048] text-white font-bold text-sm flex items-center justify-center gap-2"
                    >
                  ...
                  {/* Deposit Method Tabs */}
                  <div className="flex gap-1 sm:gap-2 border-b border-border-glass overflow-x-auto no-scrollbar">
                    {(['crypto', 'manual'] as const).map((method) => {
                      ...
                      return (
                        <button
                          ...
                          className={clsx(
                            'px-3 sm:px-4 py-2.5 text-xs sm:text-sm font-semibold transition-all border-b-2 whitespace-nowrap',
                            active
                    ...
                    <>
                      ...
                      <div className="rounded-xl border border-border-primary bg-bg-secondary px-3 py-3 sm:px-4 space-y-2 min-w-0">
                        ...
                        <button
                          ...
                          className="text-[10px] font-semibold text-[#00d048] hover:underline"
                        >
                      ...
                      <div className="space-y-1 min-w-0">
                        ...
                        >
                          ...
                          />
                          {depositProofFile ? (
                            <span className="text-sm font-medium text-[#00d048] px-2 text-center">{depositProofFile.name}</span>
                          ) : (
                      ...
                      <div className="space-y-1">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <button
                            ...
                            className="text-xs font-bold text-[#00d048] hover:underline"
                          >
                            Max
                          </button>
                        </div>
                    ...
                    <>
                      ...
                      <div className="space-y-1">
                        ...
                        >
                          ...
                          />
                          {manualWithdrawQrFile ? (
                            <span className="text-sm font-medium text-[#00d048] px-2 text-center">
