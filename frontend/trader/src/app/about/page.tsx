...
export const metadata = { title: 'About Us — EX-Setup' }
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            <p className="text-gray-500 leading-relaxed">
              EX-Setup was founded with a simple belief: trading should be accessible, transparent, and fair for everyone. We saw traders struggling with high fees, slow withdrawals, and limited access to global markets. We decided to change that.
            </p>
            <p className="text-gray-500 leading-relaxed">
              Today, EX-Setup serves thousands of traders across 150+ countries, providing them with the tools and freedom they deserve. We're not just a broker—we're a movement toward financial independence.
            </p>
            <p className="text-gray-500 leading-relaxed">
