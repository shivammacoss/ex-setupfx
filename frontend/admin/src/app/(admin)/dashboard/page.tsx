  ...
  return (
    <>
      <div className="p-4 sm:p-6 space-y-6 max-w-[1600px] mx-auto w-full">
        ...
        <div className="relative overflow-hidden rounded-xl glass-card border border-border-primary/40">
          <div
            className="absolute inset-0 pointer-events-none opacity-60"
            style={{
              background:
                'radial-gradient(circle at 0% 0%, rgba(0,230,118,0.18) 0%, transparent 45%), radial-gradient(circle at 100% 100%, rgba(0,200,83,0.12) 0%, transparent 50%)',
            }}
          />
          <div className="relative flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-5">
            <div className="flex items-center gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <span className="inline-flex items-center gap-1 px-2 py-0.5 text-xxs font-semibold tracking-wider uppercase rounded-full bg-buy/10 text-buy border border-buy/20">
            ...
            <button
              ...
              onClick={fetchData}
              disabled={loading}
              className="flex items-center justify-center gap-1.5 px-3 py-1.5 text-xs text-text-secondary hover:text-text-primary bg-bg-primary/60 border border-border-primary/60 rounded-lg hover:bg-bg-hover transition-fast disabled:opacity-50 w-full sm:w-auto shrink-0"
            >
