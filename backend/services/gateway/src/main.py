...
from .api import (
    ...
    algo_connector, algo_keys, share, analyst_views, news,
)
...
app.include_router(analyst_views.router, prefix="/api/v1/analyst-views", tags=["Analyst Views"])
app.include_router(news.router, prefix="/api/v1/news", tags=["Market News"])
