...
CREATE TABLE users (
    ...
    book_type VARCHAR(1) NOT NULL DEFAULT 'B',
...
-- Seed super admin (password: Fxartha_Admin@2026! — change in production; alembic revision 0002 re-seeds with ADMIN_EMAIL/ADMIN_PASSWORD env vars)
INSERT INTO users (email, password_hash, first_name, last_name, role, status, kyc_status)
VALUES ('admin@fxartha.com', '$2b$12$ZgUSt54zOtd8fTviaCCrl.ttfnqm83OKO0hgqFb3isHxyyckc8lJG', 'Super', 'Admin', 'super_admin', 'active', 'approved');
