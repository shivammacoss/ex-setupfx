...
--   docker compose exec -T postgres psql -U piphigh -d piphigh < backend/infra/docker/migrations-manual/001_account_groups_minimum_deposit.sql
--
-- Or inline:
--   docker compose exec postgres psql -U piphigh -d piphigh -c "ALTER TABLE account_groups ADD COLUMN IF NOT EXISTS minimum_deposit DECIMAL(18,8) DEFAULT 0;"
-- =============================================================================
